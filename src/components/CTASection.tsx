    ...
    <div className="max-w-4xl mx-auto text-center">
      ...
      >
        ...
        <p className="text-muted-foreground font-body text-lg max-w-xl mx-auto mb-10">
          Join 500+ companies using FraudShield to protect transactions, reduce false positives, and grow with confidence.
        </p>
        <div className="flex flex-wrap justify-center gap-4">
          <button
            className="px-10 py-4 rounded-lg font-display text-sm tracking-widest uppercase text-primary-foreground transition-all hover:opacity-90 hover:scale-[1.02]"
