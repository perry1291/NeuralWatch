...
const steps = [
  {
    ...
    desc: 'Real-time transaction stream via secure API gateway',
    icon: '⟩⟩',
  },
  {
    label: 'PROCESS',
    title: 'Feature Extraction',
    desc: '200+ behavioral signals extracted in <1ms',
    icon: '◈',
  },
  {
    label: 'ANALYZE',
    title: 'Neural Inference',
    desc: 'Multi-model ensemble with attention mechanisms',
    icon: '⬡',
  },
  {
    label: 'DECIDE',
    title: 'Risk Scoring',
    desc: 'Explainable AI output with confidence intervals',
    icon: '◉',
  },
];
